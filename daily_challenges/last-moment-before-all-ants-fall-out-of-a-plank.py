"""
    Problem statement
        We have a wooden plank of length n units. Some ants are walking on the plank, each ant moves with a speed
        of 1 unit per second. Some of the ants move to the left, some other move to the right.
        ...
        the right, return the movement when the last ant(s) fall out of the plank.
        ...
        Example 1:
            ...
            After that, it falls immediately out of the plank. (i.e., We can say that at t = 4.0000000001, there are no ants on the plank).
...
if __name__ == '__main__':
    s = Solution()
    print(s.getLastMoment(n = 4, left = [4,3], right = [0,1]))
