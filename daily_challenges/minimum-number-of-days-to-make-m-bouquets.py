...
class Solution:
    def minDays(self, bloomDay: List[int], m: int, k: int) -> int:
        """ 
            References: https://leetcode.com/discuss/general-discussion/786126/Python-Powerful-Ultimate-Binary-Search-Template.-Solved-many-problems
        ...
        def feasible(day):
            """ 
                Check if we can form the group of flower at that day
            """
            continuous, group = 0, 0
            for d in bloomDay:
                if day >= d:
                    continuous += 1
                    if continuous == k:
        ...
        # Perform binary search instead of exautive search
